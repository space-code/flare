...
enum Asset {
    enum Colors {
        static let dynamicBackground = ColorAsset(name: "Colors/dynamic_background")
        static let gray = ColorAsset(name: "Colors/gray")
        static let systemBackground = ColorAsset(name: "Colors/system_background")
    }
}
